...
.mil-top-panel {
    ...
    & .mil-logo {
        ...
        display: flex;
        align-items: center;
        background-image: url(../img/logo/entesla-logo_dark.png);
    ...
    &.mil-top-panel-transparent {
        ...
        & .mil-logo {
            background-image: url(../img/logo/entesla-logo_light.png);
        }
...
.mil-window-content h5, .mil-divider{display: none;}
.no-margin{margin: 0!important}
.smallFont{font-size:20px}
.feature{padding: 40px 0;}
.mil-banner .mil-banner-content h1{font-size:45px !important}
