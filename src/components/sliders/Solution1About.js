              ...
              <div className="col-lg-7">
                ...
                <div className="row mil-mb-60">
                  <div className="col-lg-6">
                    <p>
                    As an electronics engineering company specializing in new product development with in-house R&D, Entesla is committed to delivering innovative, high-quality electronic solutions powered by the latest technologies and tailored to our clients’ unique requirements. Our strength lies in offering specialized services — from advanced circuit and PCB design, embedded systems development, and IoT integration, to precision prototyping, custom enclosures, and production-ready manufacturing.

                    </p>
                  </div>
                  <div className="col-lg-6">
                    <p>
                    Our end-to-end execution process ensures seamless delivery: starting with Concept, where ideas are transformed into actionable plans; Design, where our expert engineers create cutting-edge solutions; Prototyping, where concepts are rapidly brought to life; Testing, with stringent quality and performance validation; Manufacturing, using state-of-the-art facilities for high-reliability production; and Deployment, ensuring smooth integration and operational readiness.
                    </p>
                    <p>At every stage, Entesla focuses on delivering bespoke, future-ready solutions — combining technical excellence, innovation, and customer-centric design.
</p>
                  </div>
                </div>
